		...
		private function keyShit():Void // I've invested in emma stocks
			{
				...
				notes.forEachAlive(function(daNote:Note)
				{
					...
					!FlxG.save.data.downscroll && daNote.y < strumLine.y)
					{
						...
						if(FlxG.save.data.botplay && daNote.canBeHit && daNote.mustPress && daNote.noteType == 0||
						FlxG.save.data.botplay && daNote.tooLate && daNote.mustPress && daNote.noteType == 0)
						{
							if(loadRep)
							{
